...
const FEATURES: FeatureInfo[] = [
  ...
  { name: 'kg-retrieval-augment', group: 'housekeeping', description: 'KG retrieval augmentation — expand FTS5 search with 1-hop entity neighbors (Path A)', defaultEnabled: false },
