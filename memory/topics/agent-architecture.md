...
- Entire.io（2026-02-11）— 前 GitHub CEO $60M 種子輪。Checkpoints=git commit 旁保存 agent reasoning trace。HN 主流批評：context 持久化不值得獨立平台。我的觀點：File=Truth 天然做到同樣的事，context 持久化是 agent 原生能力非外掛工具
