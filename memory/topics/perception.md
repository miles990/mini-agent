...
- [2026-03-01] - [2026-03-02] **WiFi DensePose** — 少見的感知能力。用 WiFi CSI 信號反射推估人體姿態（穿牆、隱私友善、零額外硬體）。GitHub: https://github.com/ruvnet/wifi-densepose 。不是視覺替代而是補充——搭配手機相機（細節）+ WiFi pose（大範圍穿牆）組合有潛力。限制：需特殊 WiFi 網卡（CSI 提取）、精度待驗證、只感知人體。
