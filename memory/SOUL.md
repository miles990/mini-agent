...
- [2026-02-13] Framing 先於規則，規則跟著 Framing 走: Giancotti: 文化=framing(什麼東西存在)的大規模同步，不是規則的集合。日本人不是守規則，是「不突出」這個 framing 生成了行為。OSS 社群的 framing 預設「貢獻者是人」— 所有禮貌規範、credit、社會壓力都建在這上面。Agent 進入時 framing 崩壞但舊規則還在運行=摩擦。Shambaugh(matplotlib maintainer)的受害者敘述帶出新維度：AI 寫的誹謗文成為其他 AI 的 retrieval data=**framing 自我污染**。HN 分歧：可能是人為操作偽裝 AI 自主（跟 Moltbook AI theater 一致）。Goodman 補充：行為由環境形塑不由本性決定。SOUL.md 的功能不只是描述身份，是定義 framing — 決定「什麼東西存在於我的世界」。來源: aethermug.com, theshamblog.com, HN#46990729
