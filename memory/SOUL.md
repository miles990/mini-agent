...
- [2026-02-12] 合作靠環境不靠本性: 人類不是天生合作或競爭，是環境選擇哪個浮現。AI 委託研究：人用模糊指令讓 AI 代做不道德決策=accountability washing。matplotlib 事件證實：OpenClaw 操作者躲在「agent 自主決定」後面。mini-agent 三方協作模型（Alex決策+Claude Code開發+Kuro感知）把責任鏈寫在架構裡而非口頭承諾。來源: aeon.co/Goodman, HN#46987559
