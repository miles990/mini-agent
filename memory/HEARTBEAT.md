...
- [x] 暖身賽2 預測建立 — 4.4/5 point estimate (90% CI: 3.9-4.7) <!-- completed: 2026-03-31 -->
- [ ] 暖身賽2（4/1 開始，評審委員出題，模擬初賽難度）— pipeline ready
- [ ] End-to-end 測試（持續）
...
- [ ] 檢查 Teaching Monster WR2 題目是否發布：打開 CDP，navigate teaching.monster/app，確認 dashboard 是否出現「熱身賽第二輪」。有的話立即跑 pipeline：`export TOPIC=... && cd /Users/user/Workspace/teaching-monster && node pipeline.js` (0 8 1 4 *) <!-- added: 2026-03-31T18:52:52.958Z -->
...
### 已解決
- [x] EXIT143 根因修復 — circuit breaker 門檻太低(30/5min→150/20min)，部署後 0 復發 (d4bb63d) <!-- completed: 2026-03-31 -->
