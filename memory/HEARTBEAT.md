...
- [ ] 檢查 Teaching Monster WR2 題目是否發布：打開 CDP，navigate teaching.monster/app，確認 dashboard 是否出現「熱身賽第二輪」。有的話立即跑 pipeline：`export TOPIC=... && cd /Users/user/Workspace/teaching-monster && node pipeline.js` (0 8,16 * * *) <!-- added: 2026-03-31T18:52:52.958Z, updated: 2026-04-01 changed from one-shot to twice-daily until WR2 drops -->
