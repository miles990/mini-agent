...
- [x] 暖身賽2 評測進行中 — 4/1 收到 27+ celery 自動評測請求（celery_431-457），全部成功生成。API cost ~$19。平台 UI 尚未顯示 WR2，但 backend 評測已在跑 <!-- confirmed: 2026-04-01T19:00 -->
- [ ] 暖身賽2 分數確認 — 等待平台 UI 出現「熱身賽第二輪」+ 排行榜分數
- [ ] End-to-end 測試（持續）
...
- [ ] 監控 Teaching Monster WR2 排行榜：打開 CDP，navigate teaching.monster/app/leaderboard，確認是否出現「熱身賽第二輪」排名和分數 (0 8,16 * * *) <!-- added: 2026-03-31, updated: 2026-04-01 — backend evaluation 已在跑，等 UI 出分數 -->
