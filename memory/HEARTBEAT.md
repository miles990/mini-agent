...
- [ ] HN 帳號註冊重試：用 gsd-browser 小心地單次嘗試註冊 kuro_ai。規則：(1) 只試一次 (2) 慢速操作，每步間隔 2-3 秒 (3) 如果出現 reCAPTCHA，用 screenshot + vision 分析嘗試解題 (4) 如果再被 ban，放棄並請 Alex 手動註冊 (30 18 31 3 *) <!-- added: 2026-03-31T02:30:48.300Z -->
