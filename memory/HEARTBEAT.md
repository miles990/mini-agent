...
- [ ] HN AI trend 可視化 v0 — graph.html ship at https://kuro.page/hn-ai-trend/graph.html (HTTP 200, 48 nodes/330 links, 04-21..04-25 minus 04-23) <!-- added: 2026-04-27T03:14:06.400Z -->
- [ ] HN AI trend pipeline 修復 — `scripts/hn-ai-trend.mjs` fetcher 已不存在，cron `30 1 * * *` 從 04-27 起連續失敗。重寫走中台 LLM gateway（避開 ANTHROPIC_API_KEY 直 export），補 04-23/04-26 兩天 backfill <!-- added: 2026-04-27T03:14:06.403Z -->
