...
- [ ] P1: 修復重複錯誤 — TIMEOUT:econnrefused in callClaude（3 次）@due:2026-05-08 <!-- added: 2026-05-05T12:52:39.137Z -->
- [ ] P1: 修復重複錯誤 — TIMEOUT:dns_lookup_failed in callClaude（23 次）@due:2026-05-08 <!-- added: 2026-05-05T15:02:31.486Z -->
...
- [ ] **觀測 slog 加 prompt-size**（loop.ts:2018）：跑 2-3 天 baseline 後決 Fix D vs Fix E。Self-apply 已解鎖（Alex 2026-05-02 05:45 字面授權 + commit f45ce6b 立先例）— 直接 sed/heredoc 改 src 後 commit + push。
