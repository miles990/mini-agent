...
- [ ] P0 ⚠️OVERDUE verify-cwd-guard: 下個 cycle 開場先 `pwd` + cross-check 是否在 workspace 標示的 repo，防止再次在 agent-middleware 執行 mini-agent 命令 @due:2026-04-23 <!-- added: 2026-04-22T18:00:24.325Z -->
