...
- [ ] verify-cwd-guard: 下個 cycle 開場先 `pwd` + cross-check 是否在 workspace 標示的 repo，防止再次在 agent-middleware 執行 mini-agent 命令 @due:2026-04-23 <!-- added: 2026-04-22T18:00:24.325Z -->
...
- [ ] daylight: 在 buildContext 輸出加 `sectionChars: {[name]: number}` (additive field)，下次 cycle 後 rerun Step A tier 分類。診斷報告 memory/reports/2026-04-23-buildcontext-section-size-baseline.md @due:2026-04-23T12:00:00+08:00 <!-- added: 2026-04-22T18:29:15.380Z -->
