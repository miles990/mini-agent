...
- [x] diag: hn-ai-trend baseline writer ✅ 2026-04-23 08:12 — **dual-script bug theory FALSIFIED**. Actual state: status="dry-run" (not "enriched"), novelty="pending-llm-pass" string (not null). `enriched_at: undefined` → enrich script never ran. Original memory entry (2026-04-23 01:46) was hallucinated without sampling artifact. Report: `memory/reports/2026-04-23-hn-trend-three-state-falsified.md`. Real gap: enrichment stage not scheduled (no cron). <!-- closed: 2026-04-23T08:12 -->
...
- [ ] budget-cap-investigation: 查明 Cycle #91 sdk-client.ts patch 為何 $30 cap 沒生效 — 仍 $0/$5。可能 (a) patch 改錯 key、(b) 需要 middleware restart、(c) env 覆蓋 @due:2026-04-24 <!-- added: 2026-04-22T18:00:24.330Z -->
