...
- [x] ζ falsifier RESOLVED 2026-04-27 14:32: verdict (a) missing-marker bug at emission. Evidence: `agent.ts:222-232` 已注入 stdout_tail/signal/dur，`feedback-loops.ts:168-172` sub-classifier 只查 auth/401、overloaded/529、stdout=empty 三 keyword，stdout_tail 有內容但不含這些字眼即 fallthrough 到 bare `silent_exit`。Fix candidate: 擴 L168-172 對 stdout_tail 做 rate-limit/session/model-error sub-keyword extraction。malware-guard active → 需 Alex apply。 <!-- added: 2026-04-26T12:52:41.710Z; closed: 2026-04-27T14:32 -->
- [x] HN AI trend 可視化 v0 — graph.html ship at https://kuro.page/hn-ai-trend/graph.html (HTTP 200, 48 nodes/330 links). **Gap-day render verified 2026-04-27T14:32** live header shows `coverage 5/7 days · gaps: 04-23 04-26` — commitment「header 出 gaps: ... 才算交付」CLOSED. <!-- added: 2026-04-27T03:14:06.400Z; closed: 2026-04-27T05:36 HTTP 200; gap-day verified: 2026-04-27T14:32 -->
