 ...
 *
 * Per-post differentiation: novelty + so_what derive from category
...
const STOPWORDS = new Set(['the','a','an','for','and','of','to','in','on','with','by','from','is','are','be','this','that','its','your','our','their','as','at','or','but','not','use','using','built','build','make','very','more','most','can','you']);
